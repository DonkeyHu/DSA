...
import com.donkey.msb.class35.Code01_AVLTreeMap.AVLTreeMap;
import com.donkey.msb.class36.Code01_SizeBalancedTreeMap.SizeBalancedTreeMap;
import com.donkey.msb.class36.Code02_SkipListMap.SkipListMap;
	...
	public static void functionTest() {
		...
		for (int i = 0; i < testTime; i++) {
			...
			if (treeMap.containsKey(querryK) != avl.containsKey(querryK)
					|| sbt.containsKey(querryK) != skip.containKey(querryK)
				...
				System.out.println(skip.containKey(querryK));
				break;
			}
